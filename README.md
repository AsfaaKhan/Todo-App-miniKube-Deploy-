...
### Phase IV: Cloud-Native Deployment on Minikube (NEW!)

The Todo AI Chatbot now supports containerized deployment on Kubernetes using Minikube. This provides:
...
- **Resilience**: Automatic pod recovery and rolling updates
- **Reproducibility**: Declarative infrastructure-as-code
...
- Docker Desktop (v20.x or later)
- Minikube (v1.30.x or later)
- kubectl (v1.24.x or later)
- Helm 3.x
- Minimum 8GB RAM (4GB for Minikube)
- Minimum 4 CPU cores (2 for Minikube)

#### Deployment Documentation

- **Quickstart Guide**: `specs/004-minikube-deployment/quickstart.md`
- **Deployment README**: `deployment/README.md`
- **Architecture Plan**: `specs/004-minikube-deployment/plan.md`
- **Troubleshooting**: `deployment/docs/troubleshooting.md`

#### AI-Assisted DevOps (Optional)

The deployment supports AI-powered tools for enhanced workflows:
...
See `deployment/docs/ai-tools.md` for details.
...
- `test-deployment.sh`: Run resilience tests
